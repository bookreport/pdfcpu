...
[![Test](https://github.com/bookreport/pdfcpu/workflows/Test/badge.svg)](https://github.com/bookreport/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/bookreport/pdfcpu?status.svg)](https://pkg.go.dev/github.com/bookreport/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/bookreport/pdfcpu)](https://goreportcard.com/report/github.com/bookreport/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/bookreport/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/bookreport/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/bookreport/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/bookreport/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/bookreport/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/bookreport/pdfcpu/releases).


### Using Go Modules

```
git clone https://github.com/bookreport/pdfcpu
